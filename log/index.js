...
function log() {
    return function (req, res, next) {
        ...
        logger.info(reqId + ' ' + 'Request Headers - ' + JSON.stringify(headers));
        if (req.body) {
            logger.info(reqId + ' ' + 'Request Payload - ' + omitKeys(req.body, true));
        }
        ...
        res.on('finish', function () {
            ...
            if (res && res.statusCode && res.statusCode == 200
                ...
                logger.info(reqId + ' ' + 'Response payload - ' + omitKeys(body));
            }
            next();
        });
        next();
